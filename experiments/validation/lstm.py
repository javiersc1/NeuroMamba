...
def train(model, trainloader, valloader, optimizer, scheduler, epochs=100, fold=0):
    ...
    for epoch in range(epochs):
        ...
        if epoch in [epochs-1]:
            torch.save(model.state_dict(), os.path.join(f'/home/javier/weights/loo/lstm/val_{fold}.pth'))
...
def evaluate(testloader, fold):
    ...
    model.load_state_dict(torch.load(os.path.join(f'/home/javier/weights/loo/lstm/val_{fold}.pth')))
    model.eval()
    predicted = []
    true = []
...
if __name__ == "__main__":
    ...
    mode = "home"
    if mode == "home":
        experiment_dir = "/home/javier/Desktop/DeepScore/experiments/lstm/"
        ...
        experiment_dir = "/home/javiersc/DeepScore/experiments/lstm/"
    ...
    # 6 layer, state dim 272 = [0.2119138  0.17956212 0.16532767]
