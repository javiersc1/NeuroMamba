...
if __name__ == "__main__":
    ...
    X_train, y_train = FCM(madc_loader, score_amount=score_amount, mode=modescore)
    ...
    X_test, y_test = FCM_ADNI(adni_loader, score_amount=score_amount, mode=modescore, file_mode="all")
