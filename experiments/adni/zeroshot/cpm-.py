...
if __name__ == "__main__":
    ...
    #X_train, y_train, masks_madc = CPM(madc_loader, score_amount=score_amount, mode=modescore, edge_type="negative", thresh=0.01)
    # # save files
    ...
    #X_test, y_test, masks_adni = CPM_ADNI(adni_loader, score_amount=score_amount, mode=modescore, file_mode="train", edge_type="negative", thresh=0.01)
    # # save files
