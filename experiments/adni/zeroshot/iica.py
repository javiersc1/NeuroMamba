...
from NeuroMamba.models.IICA import IICA_ADNI
from NeuroMamba.models.IICA import IICA
...
if __name__ == "__main__":
    ...
    X_test, y_test = IICA_ADNI(adni_loader, n_components=n_components, score_amount=score_amount, mode=modescore, file_mode="all")
    ...
    X_train, y_train = IICA(madc_loader, n_components=n_components, score_amount=score_amount, mode=modescore, algorithm='deflation')
