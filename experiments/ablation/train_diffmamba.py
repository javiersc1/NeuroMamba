...
def train(model, trainloader, valloader, optimizer, scheduler, epochs=100, fold=0):
    ...
    for epoch in range(epochs):
        ...
        if epoch in [4, 9,24, 49, 74, 99]:
            torch.save(model.state_dict(), os.path.join(f'/home/javier/Desktop/DeepScore/weights/loo/newmamba/b32_{fold}_{epoch+1}.pth'))
...
def evaluate(testloader, fold):
    ...
    model.load_state_dict(torch.load(os.path.join(f'/home/javier/Desktop/DeepScore/weights/loo/newmamba/b32_{fold}_{epochs}.pth')))
    model.eval()
    realScores = 0.
    predictedScores = 0.
...
if __name__ == "__main__":
    ...
    mode = "home"
    if mode == "home":
        experiment_dir = "/home/javier/Desktop/DeepScore/experiments/newmamba/"
