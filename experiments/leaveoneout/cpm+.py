...
if __name__ == "__main__":
    ...
    #X, y, _ = CPM(loader, score_amount=score_amount, mode=modescore, edge_type="positive", thresh=0.01)
    X = np.load('/home/javier/weights/cpm+_subjectFeatures.npy')
    y = np.load('/home/javier/weights/cpm+_Scores.npy')
